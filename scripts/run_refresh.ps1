<# Wrapper interactif pour lancer le refresh Convex avec valeurs par défaut #>
param(
    [string]$BackupDir = "C:\temp\convex_backups",
    [switch]$IncludeStorage
)

Write-Host "Lancement du refresh (interactive). BackupDir=$BackupDir IncludeStorage=$IncludeStorage" -ForegroundColor Cyan
